  ...
  <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
    ...
    <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
      ...
      <div className='flex-1'>
        ...
        <div className='flex w-3 gap-1 mt-2 items-center'>
    ...
    <div className='mt-20'>
      ...
      <div className='flex flex-col gap-4 border border-gray-300 px-6 py-6 text-sm text-gray-600'>
        <p>e-commerce website Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus, voluptatibus sapiente ullam aliquid voluptate nostrum blanditiis praesentium officia modi nisi?</p>
        <p>e comerce is Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vitae, error soluta nesciunt quia, corrupti nobis ex odio possimus dolor commodi nulla, ducimus optio at maxime voluptatum dicta quidem atque itaque?</p>
      </div>
    </div>
